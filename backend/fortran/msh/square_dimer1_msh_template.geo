...
Point(7) = {-hx+c1+r1r+s1, -hy/2+r1rb, 0,lc3}; // top right corner
...
Point(19) = {-hx+c1+r1r+s1, -hy/2-r1rb, 0,lc3};
...
Point(27) = {-hx+c2-r2r-s2, -hy/2+r2rb, 0,lc3};
Point(28) = {-hx+c2-r2, -hy/2, 0, lc3}; // center right
Point(29) = {-hx+c2-r2r-s2, -hy/2-r2rb, 0,lc3}; // bottom left corner
