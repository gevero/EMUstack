...
c
      ...
      character mesh_file*100, root_path*100, full_mesh_file*300
      character mid_path*100
...
c
      ui = 6
c
        root_path="/home/giovi/electrodynamics/st-matrix/EMUstack/"
        mid_path="backend/fortran/msh/"
        full_mesh_file=TRIM(root_path)//TRIM(mid_path)//TRIM(mesh_file)
        open (unit=24,file=TRIM(full_mesh_file),
     *     status='old')
        read(24,*) npt2, nel2
c
      if(npt .ne. npt2) then
